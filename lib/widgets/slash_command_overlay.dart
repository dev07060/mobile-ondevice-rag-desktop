/// Slash command auto-complete overlay for quick action selection.
...
const kSlashCommands = [
  SlashCommand(
    command: '/summary',
    label: 'Summary',
    description: 'Summarize key points from RAG results',
  ...
  SlashCommand(
    command: '/define',
    label: 'Define',
    description: 'Provide academic/practical definition of a term',
  ...
  SlashCommand(
    command: '/more',
    label: 'Expand',
    description: 'Combine RAG context with general knowledge',
