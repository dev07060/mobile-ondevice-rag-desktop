/// Document-style AI response widget with streaming markdown support.
/// Displays responses in a full-width format with source attribution.
...
class _DocumentStyleResponseState extends State<DocumentStyleResponse> {
  ...
  Widget _buildContent() {
    ...
    // For streaming messages with content, show content directly (no animation needed)
  ...
  /// Build loading animation (pulsing dots)
  ...
  /// Build markdown stylesheet (reusable)
